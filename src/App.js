...
function WelcomePage({ onStart }) {
  return (
    ...
    <p>Begin filling out the form to get started.</p>
        ...
        <div>
          ...
          <div className="form-group">
            ...
            <input
              ...
              onChange={(e) => handleDetailsChange('10th', e)}
              required
            />
          </div>
          <div className="form-group">
        ...
        <div>
          ...
          <div className="form-group">
            ...
            <input
              ...
              onChange={(e) => handleDetailsChange('12th', e)}
              required
            />
          </div>
          <div className="form-group">
        ...
        <div>
          ...
          <div className="form-group">
            ...
            <input
              ...
              onChange={(e) => handleDetailsChange('Diploma', e)}
              required
            />
          </div>
          <div className="form-group">
        ...
        <div>
          ...
          <div className="form-group">
            ...
            <input
              ...
              onChange={(e) => handleDetailsChange('Degree', e)}
              required
            />
          </div>
          <div className="form-group">
...
const renderEducationRows = (educationDetails) => {
  return Object.entries(educationDetails).map(([key, value]) => (
    <tr key={key}>
      <td>{key}</td>
      <td>{value.schoolName} {key !== '10th' && value.collegeName}</td> {/* Add college name for Diploma, 12th, and Degree */}
    ...
    <div>
      ...
      <table>
        <tbody>
          ...
          {renderAddressRows(permanentAddress)}
        </tbody>
      </table>
      <br />
      <table>
        <tbody>
          <tr><th>Field</th><th>Value</th></tr>
          {renderAddressRows(correspondenceAddress)}
        </tbody>
      </table>
      ...
      <table>
        <tbody>
          <tr><th>Type</th><th>School/College Name</th><th>Marks</th><th>Year</th></tr>
          {renderEducationRows(educationDetails)}
        </tbody>
      </table>
